...
// Cache the preloader element
const $preloader = $('#ctn-preloader');

// Bind the load event handler once
$(window).one("load", function () {
  $preloader.addClass('loaded');

  // Use CSS for fade-out effect and remove the preloader once done
  setTimeout(() => {
    $preloader.addClass('fade-out');
    
    // Delay removal of the element slightly after CSS transition ends
    setTimeout(() => $preloader.remove(), 500); // Adjust timing if needed
  }, 200); // Initial delay before fade-out
});
